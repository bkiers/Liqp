...
class For extends Tag {
    ...
    private Object renderArray(String id, Context context, LNode... tokens) {
    ...
    private Object renderRange(String id, Context context, LNode... tokens) {
    ...
    private Map<String, Integer> getAttributes(int fromIndex, Context context, LNode... tokens) {
